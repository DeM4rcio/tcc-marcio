...
Ao todo foram analisado 501 artigos resultantes da string de busca, onde 50 desses foram selecionados das quais 30 foram lidos de maneira integral. Esses artigos foram obtidos na base de dados Scopus no dia 14 de maio de 2026.Os artigos selecionados estão dispostos na Tabela~\ref{tab-artigos-slr}.


A calibração da \textit{string} de busca era determinado se o artigo \textit{Tools for monitoring software quality in information systems de-
velopment and maintenance: five key challenges and a design proposal} de \citeonline{tools2020monitoring} estava presente na base de busca e isso identificava que os resultados estavam dentro do escopo da pesquisa.
...
O corpus analisado nesta revisão estruturada da literatura é composto por 50 artigos candidatos obtidos na base de dados Scopus Figura \ref{artigos-ano}, dos quais 30 foram realizados a leitura integral e extração de dados por atenderem aos critérios de inclusão estabelecidos no protocolo. Os 15 artigos restantes foram excluídos por indisponibilidade do texto completo, por tratarem exclusivamente de qualidade de processo sem avaliação da qualidade interna do produto, ou por terem como domínio de aplicação exclusivo sistemas embarcados ou dispositivos móveis e o restante dos 5 artigos não foi concedido o acesso via \textit{Research Gate}.
